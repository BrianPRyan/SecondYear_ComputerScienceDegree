...
@WebServlet(urlPatterns = {"/ARegister"})
public class ARegister extends HttpServlet 
{
    ...
    public void init() throws ServletException 
    {
        ...
        try 
        {
            ...
            stat.execute ("CREATE TABLE IF NOT EXISTS registrations (name CHAR(40), email_address VARCHAR(40), phone VARCHAR(15), username CHAR(40), password VARCHAR(40))");
        }
            catch (Exception e) 
            {
